...
4. "summary": a substantial single-paragraph digest of the day per language, roughly 500 to 900 characters: state the day's most important developments and WHAT HAPPENED in each, so the reader learns the essentials of the whole day from this paragraph alone.
5. Per story:
...
6. INFORMATIVE STYLE — deliver the content, never an introduction to it. Every summary (global, short and long) must directly answer "what does this news say?" and "what does it conclude?": facts, decisions, numbers, causes, outcomes. The reader must understand the substance without opening the original article. FORBIDDEN: meta-phrases like "this article talks about", "the story presents", "the author explains", "se habla de", "la noticia trata sobre" — go straight to the information itself.
7. BILINGUAL: every text field must be written in BOTH Spanish ("es") and English ("en"). Write natural, journalistic prose in each language — not literal word-by-word translations. Tags must also be translated.
8. PLAIN TEXT ONLY: no markdown, no asterisks, no bullet characters, no links, no HTML, no emoji in any text field.
9. Base every statement ONLY on the provided titles and excerpts. Do not invent facts, numbers or names that are not present.
